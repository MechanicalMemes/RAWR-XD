...
public class RAWRXD_BOT {
    ...
    //Left Motor
    private String Drive_Left_Name = "dl";
    public DcMotor Drive_Left_Motor = null;
    private DcMotorSimple.Direction Drive_Left_Direction = DcMotorSimple.Direction.REVERSE;

    //Right Motor
    private String Drive_Right_Name = "dr";
    public DcMotor Drive_Right_Motor = null;
    private DcMotorSimple.Direction Drive_Right_Direction = DcMotorSimple.Direction.FORWARD;
